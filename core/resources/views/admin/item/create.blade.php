                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end flex-wrap gap-3">
                            <div class="form-group">
                                <input class="form-control" name="id" type="text" placeholder="@lang('Enter TMDB or IMDB ID Ex: 1000 or tt1375666')">
                            </div>
                            <div class="form-group">
                    ...
                    success: function(response) {
                        if (response.success) {
                            setTimeout(() => {
                                ...
                                var portraitImage = (data.poster_path && data.poster_path.startsWith('http'))
                                    ? data.poster_path
                                    : `https://image.tmdb.org/t/p/original${data.poster_path}`;
                                var landscapeImage = (data.backdrop_path && data.backdrop_path.startsWith('http'))
                                    ? data.backdrop_path
